 ...
 **/
@Service
public class TestMainService10 {
    ...
    public void testMainHasException() {
        ...
        testService.testNoException();   //service方法外部的调用，REQUIRED_NEW才会起作用，因为 Spring AOP切面特性
        int i = 1 / 0;   //模拟出现异常
    }
    ...
    public static void main(String[] args) {
        ...
        TestMainService10 testMainService = (TestMainService10) context.getBean("testMainService10");
...
class TestService {
    ...
    public void testNoException() {
        serviceB.testB("前面有异常B1插入");   //插入成功  节点2

        serviceB.testB("前面有异常B2插入");   //插入成功  节点3
    }
}